...
class UserUseCase {
            ...
            if (emailData === null) {
                ...
                if (emailData.isBlocked) {
                    ...
                    if (!emailData.isGoogleAuth) {
                        yield this.userRepository.updateGoogleAuth(emailData._id, profilePic);
                    }
    ...
    getAllUsers(page, limit, searchQuery) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!searchQuery)
                    searchQuery = '';
                const users = yield this.userRepository.findAllUsers(page, limit, searchQuery);
    ...
    addToWallet(userId, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield this.userRepository.updateWallet(userId, amount, 'Added To Wallet');
                if (user !== null)
                    return (0, response_1.get200Response)(user);
                else
                    return (0, response_1.getErrorResponse)(httpStausCodes_1.STATUS_CODES.BAD_REQUEST);
    ...
    getWalletHistory(userId, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userWallet = yield this.userRepository.getWalletHistory(userId, page, limit);
                if (userWallet)
