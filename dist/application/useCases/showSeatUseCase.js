...
class ShowSeatsUseCase {
    constructor(_showSeatRepository) {
        this._showSeatRepository = _showSeatRepository;
    }
    findShowSeatById(showSeatId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const showSeats = yield this._showSeatRepository.findShowSeatById(showSeatId);
                (0, console_1.log)(showSeatId, 'showSeatId');
                if (showSeats) {
                    return (0, response_1.get200Response)(showSeats);
                }
                else {
                    return (0, response_1.getErrorResponse)(httpStatusCodes_1.STATUS_CODES.BAD_REQUEST, 'Invalid show seat id');
                }
            }
            catch (error) {
