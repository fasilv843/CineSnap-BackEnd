...
class ShowController {
    ...
    findShowsOnTheater(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiRes = yield this.showUseCase.findShowsOnTheater(theaterId, date, 'Theater');
    ...
    findShowsOnTheaterByUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const theaterId = req.params.theaterId;
            const date = req.query.date;
            const apiRes = yield this.showUseCase.findShowsOnTheater(theaterId, date, 'User');
            res.status(apiRes.status).json(apiRes);
        });
    }
    // To add a new show
    ...
    getShowDetails(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiRes = yield this.showUseCase.getShowDetails(showId);
            res.status(apiRes.status).json(apiRes);
        });
    }
}
